...
def create_dataset_2d():
    ...
    prior_mu = torch.tensor(data[:, 5:6], **tensor_args)   # true distance
    prior_var = torch.tensor(data[:, 6:7], **tensor_args)  # sensor variance
    ...
    for e in range(epochs):
        ...
        if val_loss < best_val:
            ...
            torch.save(
                ...
                "sdf_2d_lidar_mesh_units_10m_points.pt"
            )
